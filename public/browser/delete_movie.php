...
if (in_array($id, $protected_ids)) {
    ...
    <head>
        ...
        <style>
            ...
            form { background: rgba(0,0,0,0.75); padding:20px; width:300px; margin:50px auto; border-radius:8px; }
    ...
    <body>
        ...
        <p>Esta película está protegida. Ingresa la contraseña para borrarla:</p>
        <form method="POST">
